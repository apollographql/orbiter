...
// const CLIENT_NAME = 'rover-netlify-sentry';
...
//     if (typeof process.env.SENTRY_PROJECT_ID === 'undefined') return;
//     if (typeof process.env.SENTRY_KEY === 'undefined') return;
//     const body = JSON.stringify(toSentryEvent(err, request));

//     // TODO maybe remove this because of make-fetch-happen retries?
